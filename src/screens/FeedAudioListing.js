        ...
        >
          ...
          <View style={styles.feed}>
            ...
            <TouchableOpacity style={styles.feedTop}>
              <Image
                source={require("../../assets/images/FeedAudioListing/avata01.png")}
                style={styles.avataFeed}
              ></Image>
              {/* Feed Top Right */}
            ...
            <TouchableOpacity style={styles.feedCenter}>
              <ImageBackground
                source={require("../../assets/images/FeedAudioListing/image01.png")}
          ...
          <View style={styles.feed}>
            ...
            <TouchableOpacity style={styles.feedTop}>
              <Image
                source={require("../../assets/images/FeedAudioListing/avata02.png")}
                style={styles.avataFeed}
              ></Image>
              {/* Feed Top Right */}
              <View style={styles.detailFeed}>
            ...
            <TouchableOpacity style={styles.feedCenter}>
              <ImageBackground
                source={require("../../assets/images/FeedAudioListing/image02.png")}
                style={styles.imageFeed}
              >
                <View style={styles.detailArtis}>
