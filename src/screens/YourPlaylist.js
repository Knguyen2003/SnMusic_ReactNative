    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.footer}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.song}>
            <TouchableOpacity style={styles.detailPlaylists}>
              <Image
                source={require("../../assets/images/YourPlaylist/playlist01.png")}
          ...
          <View style={styles.song}>
            <TouchableOpacity style={styles.detailPlaylists}>
              <Image
                source={require("../../assets/images/YourPlaylist/playlist02.png")}
                style={styles.imageSong}
              ></Image>
              <View style={styles.detailPlaylist}>
        ...
        <TouchableOpacity style={styles.add}>
          <Image
            source={require("../../assets/images/YourPlaylist/add.png")}
