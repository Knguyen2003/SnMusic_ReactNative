      ...
      <View style={styles.modalContainer}>
        <View style={styles.modal}>
            ...
            >
              ...
              <View style={styles.commentNum}>
                ...
                <View style={styles.commentNumLeft}>
                  <Image
                    source={require("../../assets/images/FeedCommentOnAnAudio/avata01.png")}
              ...
              <View style={styles.commentNum}>
                ...
                <View style={styles.commentNumLeft}>
                  <Image
                    source={require("../../assets/images/FeedCommentOnAnAudio/avata02.png")}
                    style={styles.avataComment}
                  />
                  <View style={styles.commentNumLeftDetail}>
                    <View style={styles.commentNumLeftDetailTop}>
                      <Text style={styles.nameComment}>Jason</Text>
                      <Text style={styles.detailNameComment}>
                        Minim magna exc
                      </Text>
                      <FontAwesome5 name="grin-hearts" size={20} color="red" />
                    </View>
              ...
              <View style={styles.commentNum01}>
                <View style={styles.commentNum}>
                  ...
                  <View style={styles.commentNumLeft}>
                    <Image
                      source={require("../../assets/images/FeedCommentOnAnAudio/avata02_2.png")}
                      style={styles.avataComment}
                    />
                    <View style={styles.commentNumLeftDetail}>
                      <View style={styles.commentNumLeftDetailTop}>
                      ...
                      <Text style={styles.detailNameComment01}>
                        officia consectetur adipi
                      </Text>
              ...
              <View style={styles.commentNum}>
                ...
                <View style={styles.commentNumLeft}>
                  <Image
                    source={require("../../assets/images/FeedCommentOnAnAudio/avata03.png")}
                    style={styles.avataComment}
                  />
                  <View style={styles.commentNumLeftDetail}>
                    <View style={styles.commentNumLeftDetailTop}>
          ...
          <View style={styles.modalBottom}>
            <Image
              source={require("../../assets/images/FeedCommentOnAnAudio/yourAvata.png")}
              style={styles.yourAvata}
            />
