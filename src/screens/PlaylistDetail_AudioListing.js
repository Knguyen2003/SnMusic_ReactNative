        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.top}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={styles.contentLeft}>
                        <ImageBackground source={require('../../assets/images/PlaylistDetail_AudioListing/top50.png')} style={styles.imageContent}>
                ...
                <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.song}>
                        <View style={styles.detailListSong}>
                            <Image source={require('../../assets/images/PlaylistDetail_AudioListing/song01.png')} style={styles.imageSong}></Image>
                    ...
                    <View style={styles.song}>
                        <View style={styles.detailListSong}>
                            <Image source={require('../../assets/images/PlaylistDetail_AudioListing/song02.png')} style={styles.imageSong}></Image>
                            <View style={styles.detailSong}>
                    ...
                    <View style={styles.song}>
                        <View style={styles.detailListSong}>
                            <Image source={require('../../assets/images/PlaylistDetail_AudioListing/song03.png')} style={styles.imageSong}></Image>
                            <View style={styles.detailSong}>
                    ...
                    <View style={styles.song}>
                        <View style={styles.detailListSong}>
                            <Image source={require('../../assets/images/PlaylistDetail_AudioListing/song04.png')} style={styles.imageSong}></Image>
                            <View style={styles.detailSong}>
                    ...
                    <View style={styles.song}>
                        <View style={styles.detailListSong}>
                            <Image source={require('../../assets/images/PlaylistDetail_AudioListing/song05.png')} style={styles.imageSong}></Image>
                            <View style={styles.detailSong}>
            ...
            <View style={styles.bottom}>
                <View style={styles.bottomLeft}>
                    <Image source={require('../../assets/images/PlaylistDetail_AudioListing/songPlay.png')} style={styles.imageSongPlay}></Image>
                ...
                <View style={styles.bottomRight}>
                    ...
                    <Image source={require('../../assets/images/PlaylistDetail_AudioListing/listenMusic.png')} style={styles.imageSongPlay01}></Image>
                </View>
            </View>
        </SafeAreaView>
    );
